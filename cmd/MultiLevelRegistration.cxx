...
namespace
{
	...
	int DoIt(int argc, char * argv[], TPixel)
	{
		...
		*/
		...
		itk::ManageTransformsFilter<PixelType>::Pointer dealWithROIs = itk::ManageTransformsFilter<PixelType>::New();
...
int main( int argc, char * argv[] )
{
	...
	/*ImageType::Pointer fixedImage = ReadInImage< ImageType >(fixedImageFilename.c_str());
	...
	try
	{
		DoIt(argc, argv, static_cast<short>(0));
	}
